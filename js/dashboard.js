...
document.addEventListener('click', (e) => {
    ...
    themeToggle.addEventListener('click', () => {
        ...
        // Also set data-theme on <html> so index.html's own CSS vars respond
        ...
        gate.innerHTML = `
            <div style="background:var(--bg-card);border-radius:24px;padding:32px;max-width:420px;width:100%;text-align:center;box-shadow:0 24px 48px rgba(0,0,0,0.3);">
                ...
                <button id="rentGatePayBtn" style="width:100%;background:var(--accent-gradient);color:white;border:none;border-radius:14px;padding:14px;font-weight:700;font-size:0.95rem;cursor:pointer;">
                    Pay Rent & Enter the Space
                </button>
                <p style="font-size:0.75rem;color:var(--text-secondary);margin-top:12px;">
                    No referral? <a href="profile.html" style="color:var(--accent-blue);">Share your referral link</a> to earn free rent days.
                </p>
            </div>
        `;
    ...
    function populateReferralCard() {
        ...
        card.innerHTML = `
            ...
            <div style="display:flex; flex-direction:column; gap:8px; margin-bottom:12px;">
                ...
                <div style="display:flex; justify-content:space-between; font-size:0.82rem;">
                    <span>Total days earned</span><strong>${earnings} day(s)</strong>
                </div>
                <div style="display:flex; justify-content:space-between; font-size:0.82rem;">
                    <span>Days credited to rent</span><strong>${credit} day(s)</strong>
                </div>
            </div>
            ${refLink ? `
